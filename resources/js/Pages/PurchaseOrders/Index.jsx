                ...
                <div className="mb-8 flex justify-between items-center">
                    <div>
                        <h1 className="text-4xl font-bold text-gray-900 mb-2 flex items-center">
                            <TruckIcon className="w-10 h-10 text-green-600 mr-3" />
                            Purchase Orders
                        </h1>
                    ...
                    <Link
                        ...
                        className="flex items-center px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-xl hover:shadow-lg transform hover:scale-105 transition-all"
                    >
                ...
                <div className="mb-6 flex flex-col sm:flex-row gap-4">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="pl-12 w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent"
                        />
                    </div>
                                    ...
                                    return (
                                        <tr key={order.order_id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <Link
                                                    href={`/purchase-orders/${order.purchase_id}`}
